...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::ItemInfo, _impl_.isalive_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ItemInfo, _impl_.itemid_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ItemInfo, _impl_.itemtype_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ItemInfo, _impl_.playerid_),
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "posY\030\006 \001(\005b\006proto3"
  ;
...
void ItemInfo::InternalSwap(ItemInfo* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ItemInfo, _impl_.posy_)
      + sizeof(ItemInfo::_impl_.posy_)
      - PROTOBUF_FIELD_OFFSET(ItemInfo, _impl_.isalive_)>(
